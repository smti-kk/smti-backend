...
@Data
@AllArgsConstructor
public class WritableTcForImport {
    @Id
    ...
    /**
     * Count of payphones/infomats/etc.
     */
    @PositiveOrZero
    @Column
    private Integer quantity;

    public WritableTcForImport() {
    }

    public WritableTcForImport(Integer id,
                               Integer operatorId,
                               String type,
    ...
    @JsonIgnore
    public boolean hasSameEqualsProperties(@Nullable WritableTcForImport lf) {
        if (lf == null) {
            return false;
        }
    ...
    @JsonIgnore
    public WritableTcForImport cloneWithNullId() {
        return new WritableTcForImport(
                null,
                getOperatorId(),
                getType(),
