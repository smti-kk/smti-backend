...
@Data
public class ExelReportLocationWithoutLogged {
    ...
    public ExelReportLocationWithoutLogged(@NotNull Location location) {
    ...
    public Comparator<String> getInternetWeightComparator() {
        return (o1, o2) -> {
    ...
    @org.jetbrains.annotations.NotNull
    public Comparator<String> getMobileWeightComparator() {
        return (o1, o2) -> {
    ...
    public Integer getInternetWeight(String operator) {
        return INTERNET_WEIGHT.get(operator.substring(0, operator.indexOf("(")).trim().toLowerCase());
    }
    public Integer getMobileWeight(String operator) {
